var game, level;
var color = ["red","blue","yellow","green","purple","lightgreen","lightblue","orange","brown","pink"];
var water = [], w=[], currentLevel, clicked=[], transferring = false, t=false, size=1, sizeChange=0.05, won=false; 
var moves = 0;
...
var testTubePosition = {
    ...
    7: [[-140,100], [-60,100], [20,100], [100,100], [-140,275], [-60,275], [20,275], [100,275], [-145,450], [-60,450],[20,450],[100,450]],
}
...
function Transfer(a,b){
    ...
    for(let i=3; i>=0; i++){
        if((water[a][i]==p[0] || water[a][i] == "transparent")){
            if(water[a][i]==p[0]){
                count++;
            }
...
function WaterDec(p,a,count){
    ...
    setTimeout(function(){
        document.getElementById("test-tube")[a].innerHTML = `<div class="colors" style = "background-color:${water[a][0]}; top:100px;"></div>
                                                             <div class="colors" style = "background-color:${water[a][1]}; top:100px;"></div>
                                                             <div class="colors" style = "background-color:${water[a][2]}; top:100px;"></div>
                                                             <div class="colors" style = "background-color:${water[a][3]}; top:100px;"></div>  `;
...
function won(){
    ...
    won = true;
    level.innerHTML = `<div id="won">You won</div><div id="restart" class="game-buttons" onclick="Restart();">Restart</div>
